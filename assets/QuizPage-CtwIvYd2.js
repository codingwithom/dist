...
import { R as RotateCcw } from "./rotate-ccw-BZ4d_Tna.js";
import { a as Copy, C as CircleCheckBig } from "./copy-CN_1bVUg.js";
import { C as CircleCheck } from "./circle-check-BO2JSq9N.js";
import { C as CircleX } from "./circle-x-CHQ96_pn.js";
import { T as Trash2 } from "./trash-2-BuiCWaDM.js";
import { S as Settings, M as Mic } from "./settings-Qs7Bj69W.js";
...
function YoutubePreview({ videoId, href, children }) {
  ...
  reactExports.useEffect(() => {
    ...
    let cancelled = false;
    __vitePreload(async () => {
      const { loadYouTubeApi } = await import("./index-DlaKRKjd.js").then((n) => n.aG);
