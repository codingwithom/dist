import { c as createLucideIcon, ad as getPipedInstances, ae as getInvidiousInstances } from "./index-BZNeIA96.js";
const __iconNode = [
  [
    "path",
    {
...
async function searchYouTubeVideos(query) {
  ...
  const fetchLocalApi = async () => {
    const apiBase = typeof import.meta !== "undefined" && "./" ? "./".replace(/\/$/, "") : "";
